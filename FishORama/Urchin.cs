...
namespace FishORama
{
    ...
    class Urchin : IDraw
    {
        ...
        public void Update()
        {
            ...
            // From line 65-89 will make sure that the piranha will be bouncing of the aquarium walls and not going off the screen
            ...
            if (tokenManager.ChickenLeg != null)  // this was me trying to figure soome things out with the chicken leg and urchins but ran low on time
            {
                if (xPosition > tokenManager.ChickenLeg.Position.X)
                {
