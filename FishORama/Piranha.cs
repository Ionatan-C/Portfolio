...
namespace FishORama
{
    ...
    class Piranha1 : IDraw
    {
        ...
        public Piranha1(string pTextureID, float pXpos, float pYpos, Screen pScreen, ITokenManager pTokenManager)
        {
        ...
        public void Update()
        {
            ...
            // From line 64-88 will make sure that the piranha will be bouncing of the aquarium walls and not going off the screen
